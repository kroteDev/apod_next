      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap">
          <p className='my-4 mr-8 text-base font-normal italic text-text-color'>
            <label className='mr-1 text-nasa-blue font-bold not-italic'>Date: </label>{ new Date(apod.date).toLocaleDateString() }            
          </p>          
          <p className='my-4 mr-8 text-base font-normal italic text-text-color'>
        ...
        <div className="actions">
          <a href={`https://apod.nasa.gov/apod/ap${apod.apodDateId}.html`} className="go-to" target="_blank" rel="noreferrer">Go To APOD</a>
...
export const getServerSideProps: GetServerSideProps = async ({...ctx}) => {  
  ...
  const apodDateId = apod.date !== undefined ? apod.date.slice(2).replace(/-/g, "") : null
  apod.apodDateId = apodDateId
